...
SOURCE_CHAT = '@baraholer'  # Откуда пересылать
DEST_CHAT = '@pugatchev999'  # Твой канал

# =========================================================
# КОД БОТА-ПЕРЕСЫЛЬЩИКА
# =========================================================
...
# =========================================================
# ВЕБ-СЕРВЕР ДЛЯ RENDER (ЧТОБЫ НЕ УСЫПАЛ)
# =========================================================
...
if __name__ == '__main__':
    ...
    # Запускаем веб-сервер (он нужен для Render)
    run_flask()
